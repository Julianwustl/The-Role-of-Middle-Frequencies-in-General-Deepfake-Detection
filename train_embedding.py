...
def run_train(args):
    ...
    dataModule = TensorLoadingModule(
        type=args.data_type,
        set=args.data_set,
    ...
    joined_path = create_path("/home/wustl/Dummy/Wustl/Deepfake/MasterThesis/model/checkpoints",args.experiment_name)
...
def parse_arguments():
    ...
    parser.add_argument("--loss_type","-lt", default="SubConLoss", type=str, choices=["SubConLoss", "BCE"])
    ...
    parser.add_argument('--filter_type',"-ft",type=str, required=False, choices=['butterworth_lowpass', 'butterworth_highpass', 'butterworth_bandpass'], help='Type of filter to use')
...
if __name__ == "__main__":
    ...
    data_types = ["ADM", "DDPM", "Diff-ProjectedGAN", "Diff-StyleGAN2", "IDDPM", "LDM", "PNDM", "ProGAN", "ProjectedGAN", "StyleGAN","coco"]
