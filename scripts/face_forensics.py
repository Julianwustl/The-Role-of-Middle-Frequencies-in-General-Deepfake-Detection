...
# python download/face_forensics.py /home/wustl/Dummy/Wustl/Deepfake/MasterThesis/data -d all -c c23 -t videos
...
ALL_DATASETS = ['original', 'Deepfakes', 'Face2Face', 'FaceShifter', 'FaceSwap',
                'NeuralTextures']
